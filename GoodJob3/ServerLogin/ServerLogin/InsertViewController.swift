...
class InsertViewController: UIViewController, UITextFieldDelegate,
    ...
    @IBAction func saveFavorite(_ sender: UIBarButtonItem) {
        ...
        if (name == "" || description == "") {
            let alert = UIAlertController(title: "입력되지 않은 내용이 있습니다", message: "Save Failed!!", preferredStyle: .alert)
        ...
        let myUrl = URL(string: "http://condi.swu.ac.kr/favorite/upload.php");
        ...
        let urlString: String = "http://condi.swu.ac.kr/favorite/insertFavorite.php"
        ...
        restString += "&duty=" + dduty + "&term=" + dterm
